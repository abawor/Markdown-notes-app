...
export default function App() {
  ...
  const sortedNotesByUpdatedAt = notes.sort((a, b) => b.updatedAt - a.updatedAt)
  const sortedNotesByFavourites = sortedNotesByUpdatedAt.sort((a, b) => 
